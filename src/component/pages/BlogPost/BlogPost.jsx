...
import "./BlogPost.css";
import PartBlogPost from "../../../part/PartBlogPost/PartBlogPost";
...
class BlogPost extends Component {
  ...
  getDataAPI = () => {
    axios
      .get("http://localhost:3005/posts?_sort=id&_order=desc")
      .then((result) => {
        this.setState({
          getData: result.data,
        });
  ...
  postDataAPI = () => {
    axios
      .post("http://localhost:3005/posts", this.state.statepostData)
      .then((resultnya) => {
        this.getDataAPI();
        this.setState(
          {
  ...
  putDataAPI = () => {
    axios
      .put(
        `http://localhost:3005/posts/${this.state.statepostData.id}`,
        ...
        <div className="wrapper-form">
          <div className="form-post">
            ...
            <input
              ...
              name="body"
              type="text"
              placeholder="input description body"
            />
          ...
          <div className="form-post">
            ...
            <label htmlFor="title">Title</label>
            <input
              value={this.state.statepostData.title}
            ...
            <label htmlFor="body">Body</label>
            <input
              value={this.state.statepostData.body}
              onChange={this.changeFormEdit}
              name="body"
              type="text"
              placeholder="input description body"
